...
const { discoveryController } = require('../../routes/discovery')
...
describe('dicovery-controller', () => {
  describe('discoveryController', () => {
    ...
    it('Check discovery response', async () => {
      ...
      expect(discoveryJson.image.href).to.equal('https://vmw-mf-assets.s3.amazonaws.com/connector-images/hub-ms-dynamics.png')
