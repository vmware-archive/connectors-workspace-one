...
package com.vmware.ws1connectors.servicenow.discovery;

import com.vmware.ws1connectors.servicenow.exception.DiscoveryMetaDataReadFailedException;
...
import static com.vmware.ws1connectors.servicenow.constants.ServiceNowConstants.CONTEXT_PATH_TEMPLATE;
...
public class DiscoveryService {
    ...
    public String getDiscoveryMetaData() {
        try (InputStream inputStream = metaDataResource.getInputStream()) {
            ...
            throw new DiscoveryMetaDataReadFailedException("Error occurred in reading discovery meta data", ioe);
        }
    }
