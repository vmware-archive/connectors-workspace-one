...
public class OrderDesktop implements BotCapability {
    private static final String ORDER_DESKTOP = "orderDesktop";
    ...
    public OrderDesktop(ConnectorTextAccessor connectorTextAccessor) {
    ...
    @Override public BotItem describe(String routingPrefix, Locale locale) {
        return new BotItem.Builder()
                .setTitle(connectorTextAccessor.getTitle(ORDER_DESKTOP, locale))
                .setDescription(connectorTextAccessor.getDescription(ORDER_DESKTOP, locale))
    ...
    public BotAction getListOfDesktopsAction(String routingPrefix, Locale locale) {
        ...
        return new BotAction.Builder()
                .setTitle(connectorTextAccessor.getTitle(ORDER_DESKTOP_ACTION, locale))
                .setDescription(connectorTextAccessor.getDescription(ORDER_DESKTOP_ACTION, locale))
                .setType(HttpMethod.GET)
                .setUrl(new Link(routingPrefix + buildActionUrl(ServiceNowCategory.DESKTOP)))
                .build();
    }
}
