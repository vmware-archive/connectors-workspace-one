...
class TimeOffTaskTest {
    ...
    @Nested
    class GetTotalTimeOffDuration {
        @Test
        void returnsTotalTimeOffDuration() {
    ...
    @Nested
    class GetInboxTaskId {
        @Test
        void returnsInboxTaskId() {
            assertThat(TIME_OFF_TASK.getInboxTaskId()).isEqualTo(INBOX_TASK_ID);
        }
    }

    @Nested
    class GetInboxTaskHref {
        @Test
        void returnsInboxTaskHref() {
    ...
    @Nested
    class GetTimeOffItems {
        @Test
        void returnsTimeOffItems() {
