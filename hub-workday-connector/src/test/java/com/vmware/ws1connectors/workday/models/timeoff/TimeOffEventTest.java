...
class TimeOffEventTest {
    ...
    @Nested
    class GetTimeOffEventDescriptor {
        @Test
        void returnsTimeOffEventDescriptor() {
    ...
    @Nested
    class GetTimeOffEntries {
        @Test
        void returnsTimeOffEntries() {
    ...
    @Nested
    class GetEventRecordsAwaitingAction {
        @Test
        void returnsEventRecordsAwaitingAction() {
