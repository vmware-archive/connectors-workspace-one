...
class ExceptionHandlersTest {
    ...
    static List<BusinessSystemException> getBusinessSystemExceptions() {
    ...
    void canHandleBusinessSystemException(final BusinessSystemException bse) {
    ...
    static Stream<Arguments> getLocalizedExceptionArguments() {
    ...
    void canHandleLocalizedException(final LocalizedException ex, final HttpStatus expectedStatus, final String expectedErrorMsg) {
    ...
    @Test
    void canGetErrorMessageInDefaultLocale() {
    ...
    @Test
    void getsDefaultLocalizedErrorMessageWhenKeyIsNotFound() {
        HttpHeaders headers = new HttpHeaders();
        headers.setAcceptLanguageAsLocales(Arrays.asList(Locale.FRANCE));
        mockServerHttpRequest = MockServerHttpRequest.get(URI)
                .headers(headers)
