...
app.post('/action/pendingAction',actionsController.pendingAction)

app.post('/action/closeAction',actionsController.pendingAction)

app.post('/action/postComment',actionsController.postComment)
