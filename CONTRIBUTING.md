...
# Contributing to connectors-workspace-one
...
contributions to this repository must be signed as described on that page. Your signature certifies that you wrote the 
...
``` shell
git remote add upstream https://github.com/vmware/connectors-workspace-one.git
