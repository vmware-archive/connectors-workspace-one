...
cp files/systemd/servicenow-connector.service /etc/systemd/system/
cp files/default-conf/logback.xml /etc/opt/vmware/connectors/
cp files/servicenow-connector.jar /opt/vmware/connectors/


sed s~{TENANT_PUBLIC_KEY_URL}~$TENANT_PUBLIC_KEY_URL~ files/systemd/servicenow-connector.service > /etc/systemd/system/servicenow-connector.service
