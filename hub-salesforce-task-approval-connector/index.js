...
// Action routes
app.post('/action/deferredTask', actionsController.performAction)

app.post('/action/completeTask', actionsController.performAction)

app.post('/action/inProgressTask', actionsController.performAction)
